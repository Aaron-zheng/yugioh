...
//        view.backgroundColor = UIColor(red: 224 / 255, green: 68 / 255, blue: 98 / 255, alpha: 1)
        ...
        // setupLoginLogo()
        //自己添加的
        self.logo = UIImage(named: "apppng")
        setupLoginLogo()
        self.view.backgroundColor = darkColor
        self.loginButtonColor = redColor
...
//        setupForgotPasswordButton()
    ...
    func setupLoginLogo() {
        ...
        let logoFrame = CGRect(x: (self.view.bounds.width - 40) / 2, y: 80, width: 40, height: 40)
    ...
    func setupEmailField() {
        ...
        imgvUserIcon.image = UIImage(named: "ic_account_box_white", in: bundle, compatibleWith: nil)
        ...
        txtEmail.attributedPlaceholder = NSAttributedString(string: "输入邮箱", attributes: [NSAttributedStringKey.foregroundColor: UIColor.white.withAlphaComponent(0.5)])
    ...
    func setupPasswordField() {
        ...
        let bundle = Bundle(for: LFLoginController.self)
        imgvPasswordIcon.image = UIImage(named: "ic_vpn_key_white", in: bundle, compatibleWith: nil)
        ...
        txtPassword.attributedPlaceholder = NSAttributedString(string: "密码", attributes: [NSAttributedStringKey.foregroundColor: UIColor.white.withAlphaComponent(0.5)])
    ...
    func setupLoginButton() {
        ...
        butLogin.setTitle("登陆", for: .normal)
    ...
    func setupSignupButton() {
        ...
        if isSignupSupported {
            ...
            let titleString = NSAttributedString(string: "还没有账号？注册一个", attributes: [NSAttributedStringKey.font: font, NSAttributedStringKey.foregroundColor: UIColor.white])
    ...
    func setupForgotPasswordButton() {
        ...
        let font = UIFont(name: "HelveticaNeue-Medium", size: 12)!
        let titleString = NSAttributedString(string: "忘记密码", attributes: [NSAttributedStringKey.font: font, NSAttributedStringKey.foregroundColor: UIColor.white])
    ...
    func toggleLoginSignup() {
        ...
        let login = isLogin ? "登陆" : "注册"
        self.butLogin.setTitle(login, for: .normal)
        
        let signup = isLogin ? "还没有账号？ 注册一个" : "已经有账号？登陆一下"
