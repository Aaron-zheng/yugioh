...
open class AutoCompleteTextField: UITextField {
    ...
    fileprivate func autocompleteBoundingRect(_ autocompleteString: String) -> CGRect {
        ...
        let textAttributes: [NSAttributedStringKey: AnyObject] = [NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): font!, NSAttributedStringKey(rawValue: NSAttributedStringKey.paragraphStyle.rawValue): paragraphStyle]
